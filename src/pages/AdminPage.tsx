...
const REPARATURAUFTRAEGE_FIELDS = [
  ...
  { key: 'fahrzeug_bezeichnung', label: 'Fahrzeug / Gerät', type: 'string/text' },
  { key: 'kennzeichen', label: 'Kennzeichen / Seriennummer', type: 'string/text' },
  { key: 'problembeschreibung', label: 'Problembeschreibung', type: 'string/textarea' },
  { key: 'mitarbeiter', label: 'Zuständiger Mitarbeiter', type: 'string/text' },
  { key: 'voraussichtliche_fertigstellung', label: 'Voraussichtliche Fertigstellung', type: 'date/date' },
  { key: 'status', label: 'Status', type: 'lookup/radio', options: [{ key: 'eingegangen', label: 'Eingegangen' }, { key: 'in_bearbeitung', label: 'In Bearbeitung' }, { key: 'fertig_zur_abholung', label: 'Fertig zur Abholung' }] },
...
const KUNDENVERWALTUNG_FIELDS = [
  ...
  { key: 'notiz_kunde', label: 'Notizen zum Kunden', type: 'string/textarea' },
];
